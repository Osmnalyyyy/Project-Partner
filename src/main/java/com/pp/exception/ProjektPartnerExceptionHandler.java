...
import com.pp.exception.message.ApiResponseError;
...
@ControllerAdvice
public class ProjektPartnerExceptionHandler extends ResponseEntityExceptionHandler {

    Logger logger = LoggerFactory.getLogger(ProjektPartnerExceptionHandler.class);
